          ...
          <ScrollView contentContainerStyle={styles.content}>
            ...
            {!analysisVisible ? (
              ...
              <View style={styles.analysisBox}>
                <Text style={[styles.analysisTitle, analysis?.success ? styles.analysisTitleSuccess : styles.analysisTitleWarning]}>{analysis?.title}</Text>
                ...
                >
                  <Text style={styles.actionText}>{analysis?.unlock ? 'Add plant' : 'Cannot add plant'}</Text>
                </TouchableOpacity>
              </View>
            )}
          </ScrollView>
